     ...
     <div class="form-row" >
        ...
        <div class="form-row" >
         <asp:GridView ID="gv" runat="server" CellPadding="4" HeaderStyle-HorizontalAlign="Center" 
                    AllowPaging="True" AllowSorting="true" PageSize="10"  CssClass="gridview" DataKeyNames="id"
                    ...
                    <asp:BoundField DataField="mensaje" HeaderText="Mensaje" NullDisplayText="mensaje"  >
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True"  Width="150px"/>
                    </asp:BoundField>                          
                    <asp:BoundField DataField="estado_descri" HeaderText="Estado" NullDisplayText="estado_descri" >
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True"  Width="150px"/>
                    </asp:BoundField>
                    <asp:BoundField DataField="reportado" HeaderText="Reportado" NullDisplayText="reportado"  >
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True"  Width="150px"/>
                    </asp:BoundField>                          
